...
public class DolphineRiderZombie : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isRun)
        {
            ...
            if (FirstPlant) {
                zombieAnimator.SetInteger("DolphineRiderZombie_status", 1);
                zombieAnimator.SetInteger("DolphineRiderZombie_status", 2);
            }
        ...
        if (health <= 0)
        {
            ...
            zombieAnimator.SetInteger("DolphineRiderZombie_status", 7);
    ...
    void jump()
    {
        ...
        //animation
        zombieAnimator.SetInteger("DolphineRiderZombie_status", 3);
    ...
    void DoSomethingElse()
    {
        ...
        zombieAnimator.SetInteger("DolphineRiderZombie_status", 4);
        speed = speed - 0.5f;
        FirstPlant = false;
    }
}
